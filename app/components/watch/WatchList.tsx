            ...
            <li key={index} className="relative">
              ...
              >
                ...
                <div className="flex flex-col h-[180px] border-t border-t-gray-400 px-[10px] pb-[15px] bg-white max-md:h-[150px] dark:bg-black dark:border-t-gray-600 max-sm:h-[170px] max-[500px]:h-[180px] max-[450px]:h-[190px]">
                  ...
                  <h4 className="tracking-tighter text-[20px] font-semibold mb-[7px] text-gray-600 line-clamp-2 max-md:text-[16px] max-md:mt-[4px] max-md:mb-[5px] max-sm:text-[15px] dark:text-point1">
                    {item.title}
                  </h4>
            ...
            <li key={index}>
              ...
              >
                <div className="min-w-[15px] h-[30px] whitespace-nowrap absolute z-10 left-[10px] top-[13px] max-sm:h-[24px]">
                  ...
                  <em className="text-point1 text-[12px] w-full text-center absolute -left-[1px] -top-[2px] leading-[30px] max-sm:leading-[24px] max-sm:text-[10px] max-sm:-left-0 max-sm:-top-0">
                    SET
                  </em>
                </div>
