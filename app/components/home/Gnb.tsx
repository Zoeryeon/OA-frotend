...
export default function Gnb() {
  return (
    <nav className="flex items-center justify-between h-[75px] max-md:absolute max-md:left-0 max-md:top-[100%] max-md:bg-point1 max-md:w-full max-md:h-auto">
